...
ActiveRecord::Schema.define(version: 2020_09_27_102824) do
  ...
  create_table "hospital_has_doctors", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
